        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3">
                            <a href="{{ route('users.index', ['sort_by' => request('sort_by')]) }}"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="progress" style="height: 10px;">
                                            <div class="progress-bar bg-white" role="progressbar"
                                                style="width: {{ $dmPercentage }}%;" aria-valuenow="{{ $dmPercentage }}"
                            ...
                            <a href="{{ route('users.index', ['sort_by' => request('sort_by')]) }}"
                                ...
                                <div class="card bg-info text-white">
                                    <div class="card-body">
                                        ...
                                        <div class="progress" style="height: 10px;">
                                            <div class="progress-bar bg-white" role="progressbar"
                                                style="width: {{ $coreTeamPercentage }}%;"
                                                aria-valuenow="{{ $coreTeamPercentage }}" aria-valuemin="0"
                        ...
                        <div class="col-md-3">
                            <a href="{{ route('users.index', ['progress_filter' => 'not_started', 'sort_by' => request('sort_by')]) }}"
                                class="text-decoration-none">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="progress" style="height: 10px;">
                                            <div class="progress-bar bg-white" role="progressbar"
                                                ...
                                                aria-valuenow="{{ $notStartedPercentage }}" aria-valuemin="0"
                                                aria-valuemax="100"></div>
                                        </div>
                ...
                <div class="ms-auto d-flex">
                    <div class="dropdown me-2">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="filterDropdown">
                            <li><a class="dropdown-item {{ request('progress_filter') == '' ? 'active' : '' }}"
                                    href="{{ route('users.index', ['sort_by' => request('sort_by')]) }}">Semua</a></li>
                            <li><a class="dropdown-item {{ request('progress_filter') == 'completed' ? 'active' : '' }}"
                                    href="{{ route('users.index', ['progress_filter' => 'completed', 'sort_by' => request('sort_by')]) }}">Selesai
                                    (100%)</a></li>
                            <li><a class="dropdown-item {{ request('progress_filter') == 'in_progress' ? 'active' : '' }}"
                                    href="{{ route('users.index', ['progress_filter' => 'in_progress', 'sort_by' => request('sort_by')]) }}">Sedang
                                    Berjalan</a></li>
                            <li><a class="dropdown-item {{ request('progress_filter') == 'not_started' ? 'active' : '' }}"
                                    href="{{ route('users.index', ['progress_filter' => 'not_started', 'sort_by' => request('sort_by')]) }}">Belum
                                    Mulai (0%)</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="dropdown me-2">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="sortDropdown">
                            <li><a class="dropdown-item {{ request('sort_by') == '' ? 'active' : '' }}"
                                    href="{{ route('users.index', ['progress_filter' => request('progress_filter')]) }}">Default</a>
                            </li>
                            <li><a class="dropdown-item {{ request('sort_by') == 'progress_asc' ? 'active' : '' }}"
                                    href="{{ route('users.index', ['sort_by' => 'progress_asc', 'progress_filter' => request('progress_filter')]) }}">Progres
                                    Terendah</a></li>
                            <li><a class="dropdown-item {{ request('sort_by') == 'progress_desc' ? 'active' : '' }}"
                                    href="{{ route('users.index', ['sort_by' => 'progress_desc', 'progress_filter' => request('progress_filter')]) }}">Progres
                                    Tertinggi</a></li>
                        </ul>
                    </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span class="badge" style="background-color: #8e44ad; color: #fff;">Disciples
                                    Maker</span>
                                @else
                            ...
                            <!-- <td>
                                <div class="progress" style="height: 15px; cursor: pointer;" data-bs-toggle="tooltip"
                                    data-bs-placement="top"
                                    title="{{ $user->name }} telah menonton {{ $user->why_video_progress }}% dari video Why"
                                    onclick="showVideoProgressDetail({{ $user->id }}, '{{ $user->name }}', {{ $user->why_video_progress }})">
                                    @php
                                    ...
                                    <div class="progress-bar {{ $progressClass }}" role="progressbar"
                                        ...
                                        aria-valuenow="{{ $user->why_video_progress }}" aria-valuemin="0"
                                        aria-valuemax="100">
                                        {{ $progressText }}
                                    </div>
                                </div>
...
<div class="modal fade" id="videoProgressDetailModal" tabindex="-1" aria-labelledby="videoProgressDetailTitle"
    aria-hidden="true">

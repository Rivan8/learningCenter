        ...
        <div class="col-lg-12">
            <div class="glass-card">
                <div class="solid-header p-4 d-flex align-items-center gap-2">
                    ...
                    <span class="solid-title">Permintaan Akses Grade 2 - The Power</span>
                </div>
                        ...
                        <table class="table table-glass align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($req->status === 'pending')
                                            <form method="POST" action="{{ route('admin.grade2-requests.approve', $req->id) }}" class="d-inline">
                                                @csrf
                                            ...
                                            <form method="POST" action="{{ route('admin.grade2-requests.reject', $req->id) }}" class="d-inline ms-1">
                                                @csrf

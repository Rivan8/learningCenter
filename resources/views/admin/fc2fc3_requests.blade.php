...
<style>
    ...
    .solid-header { background: #0ea5e9; color: #fff; border-bottom: none; box-shadow: 0 2px 12px 0 rgba(14,165,233,0.12); }
    .solid-title { color: #fff; font-weight: 700; font-size: 1.7rem; letter-spacing: 1px; }
    .table-glass thead th { background: #e0f2fe; color: #0369a1; border: none; font-weight: 600; font-size: 1.05rem; }
    .table-glass tbody tr { transition: background 0.2s; }
    .table-glass tbody tr:hover { background: rgba(14, 165, 233, 0.07); }
    ...
    .user-avatar-mini { width: 32px; height: 32px; border-radius: 50%; object-fit: cover; border: 2px solid #0ea5e9; margin-right: 8px; box-shadow: 0 2px 8px rgba(14,165,233,0.15); }
        ...
        <div class="col-lg-12">
            <div class="glass-card">
                <div class="solid-header p-4 d-flex align-items-center gap-2">
                    ...
                    <span class="solid-title">Permintaan Akses FC2 &amp; FC3</span>
                </div>
                        ...
                        <table class="table table-glass align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="user-info-container">
                                                ...
                                                @else
                                                    <img src="https://ui-avatars.com/api/?name={{ urlencode($req->user->name ?? '-') }}&background=0ea5e9&color=fff&size=64" class="user-avatar-mini" alt="User">
                                                @endif
                                                @php
                                    ...
                                    <td>
                                        @if($req->status === 'pending')
                                            <form method="POST" action="{{ route('admin.fc2fc3-requests.approve', $req->id) }}" class="d-inline">
                                                @csrf
                                                <button type="submit" class="btn-approve"
                                                    onclick="return confirm('Setujui permintaan akses FC2 & FC3 ini?')">
                                                    <i class="fas fa-check me-1"></i>Approve
                                                </button>
                                            </form>
                                            <form method="POST" action="{{ route('admin.fc2fc3-requests.reject', $req->id) }}" class="d-inline ms-1">
                                                @csrf
                                                <button type="submit" class="btn-reject"
                                                    onclick="return confirm('Tolak permintaan akses FC2 & FC3 ini?')">
                                ...
                                <tr>
                                    <td colspan="6" class="text-center text-muted py-4">
                                        ...
                                        Belum ada permintaan akses FC2 &amp; FC3.
                                    </td>
                                </tr>
                                @endforelse
                            </tbody>

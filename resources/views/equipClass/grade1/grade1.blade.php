    ...
    <div id="heroCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <div class="carousel-inner rounded-4 shadow-lg overflow-hidden">
            ...
            <div class="carousel-item">
                ...
                <div class="carousel-caption d-none d-md-block text-start pb-5 mb-4">
                    <h1 class="display-4 fw-bold">ESC Equip - Foundation Class 3</h1>
                                ...
                                <div class="card h-100 shadow-sm rounded-4 overflow-hidden">
                                    <div class="position-relative">
                                        ...
                                        <div class="card-img-overlay d-flex align-items-end"
                                            ...
                                            <h4 class="text-white fw-bold mb-3">Grade 1 - Alkitab</h4>
                                        </div>
                                    </div>
                                    <div class="card-body d-flex flex-column justify-content-between p-4">
                                        <div>
                                            <div class="d-flex align-items-center mb-3">
                                                ...
                                                <h5 class="card-title mb-0">Grade 1 - Alkitab</h5>
                                            </div>
                                            <p class="card-text">Grade 1 - Alkitab memberikan pemahaman
                                        ...
                                        <button type="button" class="btn btn-primary-custom w-100 mt-3"
                                            data-bs-toggle="modal" data-bs-target="#modal-g1-alkitab">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="card h-100 shadow-sm rounded-4 overflow-hidden">
                                    <div class="position-relative">
                                        ...
                                        <div class="card-img-overlay d-flex align-items-end"
                                            style="background: linear-gradient(to top, rgba(42, 47, 91, 0.8), transparent);">
                                            <h4 class="text-white fw-bold mb-3">Grade 1 - Allah</h4>
                                        </div>
                                    </div>
                                    <div class="card-body d-flex flex-column justify-content-between p-4">
                                        <div>
                                            <div class="d-flex align-items-center mb-3">
                                                ...
                                                <h5 class="card-title mb-0">Grade 1 - Allah</h5>
                                            </div>
                                            <p class="card-text">Grade 1 - Allah membahas mengenai pengenalan akan pribadi Allah, sifat-sifat-Nya, dan bagaimana kita membangun hubungan yang intim dengan Sang Pencipta dalam kehidupan sehari-hari.</p>
                                        </div>
                                        <button type="button" class="btn btn-primary-custom w-100 mt-3"
                                            data-bs-toggle="modal" data-bs-target="#modal-g1-allah">
                                            <i class="fas fa-play-circle me-2"></i> Tonton Video
                                        </button>
                                    </div>
                                </div>
...
@include('equipClass.grade1.modal-g1-alkitab')
@include('equipClass.grade1.modal-g1-allah')
